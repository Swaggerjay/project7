...
<body>
  ...
  <header class="site-header" id="top">
    <div class="container header-inner">
      <a class="brand" href="/phpcourse/project7/">
      ...
      <div class="user-nav">
        <a href="/phpcourse/project7/auth/login.php" class="active">
    ...
    <section class="form-section">
      <div class="container">
        <div class="form-card">
          ...
          <form action="/phpcourse/project7/auth/login_action.php" method="post">
            ...
            <p style="margin-top:16px;">
              New here? 
              <a href="/phpcourse/project7/auth/register.php" style="color:var(--gold);font-weight:600;">Create an account</a>.
            </p>
