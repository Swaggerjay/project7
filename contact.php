...
<?php if ($showConfirm): ?>
  <div class="modal-overlay is-visible" role="dialog" aria-modal="true">
    <div class="modal-card">
      ...
      <button class="btn primary modal-close" type="button" onclick="window.location='contact.php'">Return Home</button>
    </div>
  </div>
<?php endif; ?>
    ...
    <section class="section">
      <div class="container contact-grid">
        ...
        <div class="info-sidebar reveal-right">
          ...
          <!-- MAP MOCKUP -->
          <!-- <div class="map-mockup reveal-up" style="--delay: 0.5s">
            <img src="images/real-2.jpg" alt="Our Studio Location" style="filter: contrast(1.2) grayscale(0.5);">
          </div> -->
