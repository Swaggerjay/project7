    ...
    <div class="container hero-content text-center">
      <div class="reveal-fade">
        ...
        <div class="hero-actions reveal-up" style="--delay: 0.8s">
          <a class="btn primary" href="pages/products.php">Explore Collections</a>
          <a class="btn ghost" href="pages/about.php">Our Story</a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid cards-3">
        ...
        ?>
          <div class="product-card reveal-up">
            <a href="pages/product_details.php?id=<?php echo $product['id']; ?>" class="product-card-link">
              <img src="<?php echo htmlspecialchars($product['image']); ?>" alt="">
              <h3><?php echo htmlspecialchars($product['name']); ?></h3>
            </a>
            <p class="product-price">₹<?php echo number_format($product['price']); ?></p>
            <div class="product-actions">
              <a href="pages/product_details.php?id=<?php echo $product['id']; ?>" class="btn primary" style="width: 100%; text-align: center;">View Details</a>
            </div>
          </div>
        <?php endforeach; ?>
      </div>
