      ...
      <?php if (empty($lines)): ?>
        <div class="card">
          ...
          <div style="margin-top:18px;">
            <a class="btn primary" href="/phpcourse/project7/pages/products.php">Shop Products</a>
          </div>
        </div>
      <?php else: ?>
        <form action="/phpcourse/project7/actions/cart_action.php" method="post">
        ...
        <div class="cart-summary">
          ...
          <div>
            <a class="btn primary" href="/phpcourse/project7/actions/checkout.php">Proceed to Checkout</a>
          </div>
        </div>
      <?php endif; ?>
    </div>
